    ...
    <div className="auth-page" id="login-page">
      <div className="auth-card">
        ...
        <form className="auth-form" onSubmit={handleSubmit} id="login-form">
          ...
          <button type="submit" className="auth-form__submit" disabled={loading} id="login-submit">
          ...
          <button type="button" className="auth-form__google-btn" onClick={handleGoogleLogin} disabled={loading} id="google-login">
